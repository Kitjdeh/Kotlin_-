...
import com.example.coinmonitoring.databinding.FragmentIntro2Binding
import com.example.coinmonitoring.view.SelectActivity
...
class IntroFragment2 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Timber.d("onCreate : Intro22222222")
